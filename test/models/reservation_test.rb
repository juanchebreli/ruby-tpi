...
class ReservationTest < ActiveSupport::TestCase
  ...
  test 'invalid without state' do
    @reservation.state= nil
    refute @reservation.valid?, 'reservation is valid without a state'
    assert_not_nil @reservation.errors[:state], 'no validation error for state'
  end
